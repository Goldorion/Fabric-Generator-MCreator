...
* Added support for mod elements: advancement, armor, biome, command, creative tab, custom element, dimension, enchantment, food, fuel, function, game rule, gui, item, key binding, loot table, music disc, overlay, painting, particle, potion effect, potion item, procedure, recipe, structure, tag
