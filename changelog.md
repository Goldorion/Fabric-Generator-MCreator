...
* Added support for mod elements: advancement, armor, block, code, command, enchantment, function, game rule, gui, item, item extension, living entity, loot table, music disc, overlay, plant, potion, potion effect, procedure, ranged item, recipe, structure, tab, tag, tool
