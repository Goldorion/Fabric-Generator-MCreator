...
* Added support for mod elements: advancement, biome, creative tab, custom element, fuel, function, game rule, loot table, painting, potion effect, procedure, recipe, tag
