...
* Added support for mod elements: advancement, biome, command, creative tab, custom element, fuel, function, game rule, key binding, loot table, painting, potion effect, procedure, recipe, tag
