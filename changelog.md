...
* Added support for new item related procedure blocks: Can smelt, check rarity, damage, enchanted with xp, fuel power, get food value, get max damage, get saturation value, is food, is tool, is name, name, NBT logic/number/String get/set, set display name, show totem like animation, item entity to itemstack, get count, grow, itemstack iterator, remove specific enchantment, shrink
