...
* Added support for new item related procedure blocks: can smelt, check rarity, damage, enchanted with xp, fuel power, get food value, get max damage, get saturation value, is food, is tool, is name, name, NBT logic/number/String get/set
### Snapshot 1
