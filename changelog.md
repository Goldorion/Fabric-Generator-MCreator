...
* Added support for mod elements: advancement, biome, command, creative tab, custom element, enchantment, food, fuel, function, game rule, key binding, loot table, painting, particle, potion effect, procedure, recipe, tag
