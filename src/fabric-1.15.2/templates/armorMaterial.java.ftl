...
import net.fabricmc.api.Environment;
	...
	${name}("${registryname}", ${data.maxDamage}, new int[]{${data.damageValueBoots}, ${data.damageValueLeggings}, ${data.damageValueBody}, ${data.damageValueHelmet}}, ${data.enchantability}, SoundEvents.${data.equipSound?replace(modid, JavaModName)(":", ".")}, ${data.toughness}F, () -> {
